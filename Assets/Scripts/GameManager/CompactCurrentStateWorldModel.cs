...
namespace Assets.Scripts.GameManager
{
    ...
    public class CompactCurrentStateWorldModel : CompactFutureStateWorldModel
    {

        public CompactCurrentStateWorldModel(GameManager gameManager, List<Action> actions, List<Goal> goals) : base(gameManager, actions)
        {
            this.Parent = null;
        }
